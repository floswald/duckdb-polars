...
```sh
mkdir nyc-taxi
aws s3 cp s3://ursa-labs-taxi-data/2009 nyc-taxi/ --recursive --no-sign-request
aws s3 cp s3://ursa-labs-taxi-data/2010 nyc-taxi/ --recursive --no-sign-request
aws s3 cp s3://ursa-labs-taxi-data/2011 nyc-taxi/ --recursive --no-sign-request
aws s3 cp s3://ursa-labs-taxi-data/2012 nyc-taxi/ --recursive --no-sign-request
```
...
open_dataset("s3://ursa-labs-taxi-data/2010") |>
    write_dataset(data_path, partition = "month")
```
